...
async function main() {
  ...
  await prisma.storeProfile.upsert({
    ...
    create: {
      ...
      name: 'TB Mulya Abadi',
      description:
        'Toko Bangunan Mulya Abadi menyediakan berbagai kebutuhan material bangunan berkualitas tinggi dengan harga terjangkau. Melayani kebutuhan konstruksi rumah, gedung, dan renovasi.',
  ...
  const products = [
    // SEMEN
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000030',
    },
    {
    ...
    // BATA
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000031',
    },
    {
  ...
  const moreProducts = [
    // ATAP
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000032',
    },
    {
    ...
    // CAT
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000033',
    },
    {
    ...
    // BESI
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000034',
    },
    {
    ...
    // KERAMIK
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000035',
    },
    {
  ...
  const evenMoreProducts = [
    // PIPA PVC
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000036',
    },
    {
    ...
    // KAYU
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000037',
    },
    {
    ...
    // PASIR
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000038',
    },
    {
    ...
    // KERIKIL
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000039',
    },
    // LISTRIK
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000040',
    },
    {
    ...
    // ALAT
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000041',
    },
    {
    ...
    // PERALATAN AIR
    {
      ...
      status: ProductStatus.ACTIVE, categoryId: '00000000-0000-0000-0000-000000000042',
    },
    {
